...
class ManagersTimeoff extends StatefulWidget {
  ManagersTimeoff({Key key}) : super(key: key);

  @override
  _ManagersTimeoffState createState() => _ManagersTimeoffState();
}

class _ManagersTimeoffState extends Base<ManagersTimeoff> {
  List<Time> _timereq = [];
  User _user;
